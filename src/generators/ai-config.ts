...
## 🧠 THIS IS YOUR BRAIN: \`.nexus/docs/index.md\`

**READ \`.nexus/docs/index.md\` FIRST TO GROUND YOURSELF.**
...
RULE: When the user asks a question → check the index first
RULE: When you finish a feature → update the index, and the knowledge base then suggest the next item
